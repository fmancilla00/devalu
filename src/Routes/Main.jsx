    ...
    <div className='flex flex-col items-center justify-center w-full min-h-screen'>
      <div className='drop-shadow-2xl text-teal-950 md:px-15 lg:rounded-lg sm:rounded-md bg-neutral-50 w-screen lg:w-[80%]  min-h-screen lg:min-h-0 flex flex-col items-center justify-start lg:my-10'>
        <div className='flex items center flex-col justify-center w-full lg:h-full lg:p-5'>
          <section className='mt-10 relative sm:w-72 my-5 w-72 lg:w-full border-4 border-teal-200 p-1  mx-auto rounded-lg flex items-center justify-around gap-3 text-xs lg:text-base font-medium h-fit lg:justify-around lg:h-28'>
              <h1 className='absolute bottom-[90px] lg:bottom-[96px] bg-neutral-50 px-2 uppercase font-bold text-3xl lg:text-4xl  titulo'>Devalu</h1>
          ...
          {error &&
             <div className='text-xs w-full px-6 justify-center flex items-center text-red-500'>
               <p>Hubo un error al recibir los datos actualizados de inflación mensual. Los cálculos ser realizarán con los últimos datos guardados.</p>
             </div>
          }
